...
"""
noteslist = notesapp.noteslist(name=["wydatki"])

print(f"There are {len(noteslist)} notes.")

# List of names of notes in noteslist
note_names = noteslist.name
print(noteslist.body)
print(noteslist.plaintext)
print(noteslist.creation_date)
print(noteslist.modification_date)
print(noteslist.asdict())
print(note_names)
